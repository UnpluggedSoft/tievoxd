...
const string TIEVoxInfo::ActionTypes[] = {ACTION_TYPE_PLAY_SOUND, ACTION_TYPE_LED, ACTION_TYPE_SYSTEM};
...
const ToKeyMap::value_type srcnx[] = { 
...
const ToKeyMap TIEVoxInfo::SoundRepeats(srcnx, srcnx + sizeof srcnx / sizeof srcnx[0]);

const FromKeyMap::value_type srcx[] = { 
